...
function IngredientDetails({ type }: IngredientDetailsProps) {
  ...
  return (
    <>
      ...
      {!isLoading &&
        !hasError &&
        data.length > 0 && ingredient && (<div className={type === 'modal' ? `${styles.container} pt-10 pb-15 pr-10 pl-10` : `${styles.container} pt-30 pb-15 pr-10 pl-10`}>
